"""Upload the original DOCX to Cloudflare R2, byte for byte."""
...
def upload_docx(data: bytes, key: str) -> tuple[str, bool]:
    """Upload the DOCX unless the identical object is already there.
    ...
    extra = {"ContentType": DOCX_CONTENT_TYPE}
