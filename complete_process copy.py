...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--scale", type=float, default=None, help="Upscale factor before OCR")
    parser.add_argument("--cutoff-ratio", type=float, default=None, help="Fallback main-column width fraction")
